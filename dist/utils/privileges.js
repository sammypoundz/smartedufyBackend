...
exports.DEFAULT_ROLES = exports.SYSTEM_ROLE_PRIVILEGES = exports.ALL_PRIVILEGES = void 0;
// Every guardable page in the system. `key` values are stored on
// RoleDef.privileges and User.allowedPages.
exports.ALL_PRIVILEGES = [
    // Academic
...
exports.SYSTEM_ROLE_PRIVILEGES = {
    ADMIN: exports.ALL_PRIVILEGES.map((p) => p.key),
    PRINCIPAL: exports.ALL_PRIVILEGES.map((p) => p.key),
    VICE_PRINCIPAL: [
        "classes",
        "subjects",
        "students",
